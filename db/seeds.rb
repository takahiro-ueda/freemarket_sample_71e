...
# 服サイズ
Size.create(size: "XXS以下")
Size.create(size: "XS(SS)")
Size.create(size: "S")
Size.create(size: "M")
Size.create(size: "L")
Size.create(size: "XL(LL)")
Size.create(size: "2XL(3L)")
Size.create(size: "3XL(4L)")
Size.create(size: "4XL(5L)以上")
Size.create(size: "FREE SIZE")
# 靴のサイズ
Size.create(size: "23.5cm以下")
Size.create(size: "24.0cm")
Size.create(size: "24.5cm")
Size.create(size: "25.0cm")
Size.create(size: "25.5cm")
Size.create(size: "26.0cm")
Size.create(size: "26.5cm")
Size.create(size: "27.0cm")
Size.create(size: "27.5cm以上")
Size.create(size: "FREE SIZE")